...
Component.options.__file = "/Users/bodya/_project/vue-js-modal/src/Modal.vue"
      ...
      if (value) {
        ...
        setTimeout(function () {
          ...
          _this.$nextTick(function () {
            _this.$emit(_this.afterEvent.name, _this.afterEvent.data);
    ...
    addDraggableListeners: function addDraggableListeners() {
      ...
      if (dragger) {
        ...
        var mousedown = function mousedown(event) {
          ...
          startX = clientX;
          startY = clientY;
          cachedShiftX = _this4.shift.left;
          cachedShiftY = _this4.shift.top;
        ...
        var _mousemove = function _mousemove(event) {
          ...
          _this4.shift.left = cachedShiftX + clientX - startX;
          _this4.shift.top = cachedShiftY + clientY - startY;
          event.preventDefault();
        };
...
Component.options.__file = "/Users/bodya/_project/vue-js-modal/src/Resizer.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
